...
import top.aikele.utils.IpUtils;
import top.aikele.utils.MathUtils;
...
//            cpu.put("cpucard", processor);//cpu信息
        ...
        private static List setSysFiles(OperatingSystem os) {
            ...
            List<OSFileStore> storeList = fileSystem.getFileStores();
            List list = Lists.newArrayList();
            for (OSFileStore fs : storeList) {
